    ...
    <>
      <div className="breadhead">
        <Helmet>
          ...
          <meta
            name="description"
            content="Insightful blog section by Arena Animation covering the latest, news, trends, tips and industry insights in animation, VFX, graphics and more. Call us to know more!"
          />
      ...
      <Container>
        <Row className="mt-n5">
          ...
          >
            <div className="blog-grid">
              <div className="blog-grid-img position-relative">
                <Link to="/blog/choosing-animation-delhi-ncr-for-your-3d-animation-course-an-informed-decision">
                  {" "}
                  <img
                    alt="img"
              ...
              <div className="blog-grid-text p-4">
                ...
                <p className="display-30">
                  Regarding skills in 2D animation, Animation Delhi NCR offers a
                  unique opportunity and professionally trained animators in
                  Noida
                </p>
                <div className="meta meta-style2">
                  <ul>
                    <li>
                      <Link To="/blog/choosing-animation-delhi-ncr-for-your-3d-animation-course-an-informed-decision">
                        <i className="fas fa-calendar-alt"></i> {"24 Jul, 2024"}
                      </Link>
                    </li>
                  </ul>
                </div>
          ...
          >
            <div className="blog-grid">
              <div className="blog-grid-img position-relative">
                <Link to="/blog/elevate-your-creativity-with-animation-delhi-ncrs-2d-animation-course-in-noida">
                  {" "}
                  <img
                    alt="img"
              ...
              <div className="blog-grid-text p-4">
                ...
                <div className="meta meta-style2">
                  <ul>
                    <li>
                      <Link To="/blog/elevate-your-creativity-with-animation-delhi-ncrs-2d-animation-course-in-noida">
                        <i className="fas fa-calendar-alt"></i> {"20 Jul, 2024"}
                      </Link>
                    </li>
                  </ul>
                </div>
          ...
          >
            <div className="blog-grid">
              <div className="blog-grid-img position-relative">
                <Link to="/blog/oscar-2020-winner-and-nominees-for-best-visual-effects">
                  {" "}
                  <img
                    alt="img"
              ...
              <div className="blog-grid-text p-4">
                ...
                <div className="meta meta-style2">
                  <ul>
                    <li>
                      <Link To="/blog/oscar-2020-winner-and-nominees-for-best-visual-effects">
                        <i className="fas fa-calendar-alt"></i> {"19 May, 2024"}
                      </Link>
                    </li>
                  </ul>
                </div>
          ...
          >
            <div className="blog-grid">
              <div className="blog-grid-img position-relative">
                <Link to="/blog/can-animation-be-considered-as-an-art-form">
                  <img
                    alt="img"
              ...
              <div className="blog-grid-text p-4">
                ...
                <p className="display-30">
                  The things that usually come to our mind when we hear the word
                  “Art”
                </p>
                <div className="meta meta-style2">
                  <ul>
                    <li>
                      <Link To="/blog/can-animation-be-considered-as-an-art-form">
                        <i className="fas fa-calendar-alt"></i> {"26 Apr, 2024"}
                      </Link>
                    </li>
                  </ul>
                </div>
          ...
          >
            <div className="blog-grid">
              <div className="blog-grid-img position-relative">
                <Link to="/blog/ux-designing-process-simplified-for-absolute-beginners">
                  <img
                    alt="img"
              ...
              <div className="blog-grid-text p-4">
                ...
                <div className="meta meta-style2">
                  <ul>
                    <li>
                      <Link To="/blog/ux-designing-process-simplified-for-absolute-beginners">
                        <i className="fas fa-calendar-alt"></i> {"25 Mar, 2023"}
                      </Link>
                    </li>
                  </ul>
                </div>
          ...
          >
            <div className="blog-grid">
              <div className="blog-grid-img position-relative">
                <Link to="/blog/get-the-basics-right-12-principles-of-animation-part-2">
                  <img
                    alt="img"
              ...
              <div className="blog-grid-text p-4">
                ...
                <p className="display-30">
                  And we’re back! In the previous blog, we covered the first six
                ...
                <div className="meta meta-style2">
                  <ul>
                    <li>
                      <Link To="/blog/get-the-basics-right-12-principles-of-animation-part-2">
                        <i className="fas fa-calendar-alt"></i> {"16 Feb, 2024"}
                      </Link>
                    </li>
                  </ul>
                </div>
